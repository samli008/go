...
export default {
    ...
    methods: {
        view(scope){
            this.$router.push("/labView/"+scope.row.name)
        },
        edit(scope){
            this.$router.push("/labEdit/"+scope.row.name)
        },
        create(){
        ...
        del(scope){
            this.$confirm('确认删除?', '提示', {
                ...
                this.$axios.delete("/doc/"+scope.row.name);
        ...
        search(){
            this.$refs.form.validate((valid) => {
                if (valid) {
                    this.$axios.get(`/doc/${this.article.value}/${this.article.data}`).then(res=>{
